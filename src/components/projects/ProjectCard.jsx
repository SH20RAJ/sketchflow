...
export function ProjectCard({ project, onDelete }) {
    ...
    return (
        <Card
            className="group relative overflow-hidden hover:shadow-md transition-all duration-300 bg-white/60 backdrop-blur-sm border border-gray-200/50 rounded-lg h-auto min-h-[200px] sm:min-h-[220px] flex flex-col hover:scale-[1.01] hover:bg-white/90"
            style={{
            ...
            <CardHeader className="relative flex-shrink-0 pb-3">
                ...
                <CardDescription className="text-sm text-gray-500 line-clamp-2 group-hover:text-gray-600 transition-colors duration-200 relative z-10 mt-3 mb-2">
                    {project.description || "No description"}
                </CardDescription>
            </CardHeader>
            <CardContent className="flex-1 relative z-10 pb-0 mt-auto">
            ...
            <CardFooter className="flex justify-between mt-auto pt-2 sm:pt-3 border-t border-gray-100/50">
                <div className="flex gap-1 sm:gap-1.5 flex-1">
                    <Button
                        variant="ghost"
                        size="sm"
                        className="text-gray-600 hover:text-blue-600 hover:bg-blue-50/80 transition-all duration-200 rounded-md h-7 sm:h-8 px-1.5 sm:px-2"
                    ...
                    <Button
                        variant="ghost"
                        size="sm"
                        className="text-gray-600 hover:text-purple-600 hover:bg-purple-50/80 transition-all duration-200 rounded-md h-7 sm:h-8 px-1.5 sm:px-2"
                        onClick={() => setShowTagDialog(true)}
                    >
